...
class Main extends StatefulWidget {
  ...
  static const routeName = '/sliverheader_shrink';
          ...
          delegate: SliverChildListDelegate(
             <Widget>[
                ...
                TextButton(
                  ...
                  onPressed: () => {},
                  child: const Text('TextButton with NoSplash')
                ),
                const Chip(
                ...
                CupertinoButton(
                  child: const Chip(
                    avatar: Icon(CupertinoIcons.back),
                    labelPadding: EdgeInsets.zero,
                    label: Text('နောက်', strutStyle: StrutStyle(),),
                  ),
                  onPressed: () => {},
                ),
                CupertinoButton(
                  child: const Chip(
                    avatar: Icon(CupertinoIcons.back),
                    labelPadding: EdgeInsets.zero,
                    label: Text('အိမ်', strutStyle: StrutStyle(),),
                  ),
                  onPressed: () => {},
                ),
